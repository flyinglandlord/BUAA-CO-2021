...
`define StartAddrUART       32'h0000_7f20
`define EndAddrUART         32'h0000_7f3b

`define StartAddrDigTube    32'h0000_7f40
`define EndAddrDigTube      32'h0000_7f47

`define StartAddrSwitch     32'h0000_7f50
`define EndAddrSwitch       32'h0000_7f57

`define StartAddrKey        32'h0000_7f58
`define EndAddrKey          32'h0000_7f5b

`define StartAddrLED        32'h0000_7f60
`define EndAddrLED          32'h0000_7f63
...
`define B     8'b11100000
`define C     8'b10110001
`define D     8'b11000010 
`define E     8'b10110000
`define F     8'b10111000